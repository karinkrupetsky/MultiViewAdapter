...
import kotlinx.android.synthetic.main.vertical_view.view.*


class VerticalPhotoAdapter(private val listener: Adapter.PictureAdapterListener) : ListAdapter <Pictures, RecyclerView.ViewHolder>(
    Callback()
) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
           return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.vertical_view,parent,false))
    }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val photoImage: ImageView = itemView.vertical_img
